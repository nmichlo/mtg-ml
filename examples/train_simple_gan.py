...
if __name__ == '__main__':
    ...
    def main(data_path: str = None, resume_path: str = None, wandb: bool = False):
        ...
        trainer = make_mtg_trainer(train_epochs=500, visualize_period=500, resume_from_checkpoint=resume_path, visualize_input={'samples': vis_input}, wandb_enabled=wandb, wandb_project='MTG-GAN', wandb_name='MTG-GAN')
